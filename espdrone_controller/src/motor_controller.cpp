...
public:
  MotorController(): nh("~")
  {
    ...
    base_wrench_pub = nh.advertise<geometry_msgs::Wrench>("/drone" + drone_index + "/base_link_" + drone_index + "/wrench", 1);
  ...
  {
    wrench_ = *command;
    tmp_wrench.force.x = wrench_.wrench.force.x;
    tmp_wrench.force.y = wrench_.wrench.force.y;
    tmp_wrench.force.z = wrench_.wrench.force.z;
    tmp_wrench.torque.x = wrench_.wrench.torque.x;
    tmp_wrench.torque.y = wrench_.wrench.torque.y;
    tmp_wrench.torque.z = wrench_.wrench.torque.z;
    base_wrench_pub.publish(tmp_wrench);
